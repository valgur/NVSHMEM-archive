...
const nvshmemi_version_t nvshmemi_device_lib_version = {NVSHMEM_VENDOR_MAJOR_VERSION,
                                                        NVSHMEM_VENDOR_MINOR_VERSION,
                                                        NVSHMEM_VENDOR_PATCH_VERSION};
__constant__ nvshmemi_version_t nvshmemi_device_lib_version_d = {NVSHMEM_VENDOR_MAJOR_VERSION,
                                                                 NVSHMEM_VENDOR_MINOR_VERSION,
                                                                 NVSHMEM_VENDOR_PATCH_VERSION};
...
int nvshmemi_init_thread(int requested_thread_support,
    ...
    if (nvshmemi_is_version_compatible(nvshmemi_device_lib_version, nvshmem_app_version) != 0) {
        printf("NVSHMEM version used in application does not match with NVSHMEM device library version\n");
        return 1;
    }
