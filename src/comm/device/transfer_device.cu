...
template __device__ void nvshmemi_transfer_rma \
...
__device__ void nvshmemi_transfer_put_signal(void *rptr, void *lptr, size_t bytes,
...
template __device__ void nvshmemi_transfer_put_signal \
...
template __device__ void nvshmemi_transfer_rma_nbi \
    <SCOPE, NVSHMEMI_OP_PUT>(void *rptr, void *lptr, size_t bytes, int pe); \
template __device__ void nvshmemi_transfer_rma_nbi \
    <SCOPE, NVSHMEMI_OP_GET>(void *rptr, void *lptr, size_t bytes, int pe);
...
template __device__ Type nvshmemi_transfer_amo_fetch<Type>(void *rptr, const Type value, const Type compare, int pe, nvshmemi_amo_t op);
...
template __device__ void nvshmemi_transfer_amo_nonfetch<Type>(void *rptr, const Type value, int pe, nvshmemi_amo_t op);
